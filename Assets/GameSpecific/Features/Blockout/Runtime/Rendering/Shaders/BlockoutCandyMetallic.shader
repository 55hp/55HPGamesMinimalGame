Shader "hp55games/Blockout/Candy Metallic"
{
    Properties
    {
        ...
        _RimIntensity("Rim Intensity", Range(0, 2)) = 0.34
        _BubbleStrength("Bubble Strength", Range(0, 1)) = 0.06
        _CrystalScale("Crystal Scale", Range(1, 24)) = 8
        _CrystalStrength("Crystal Strength", Range(0, 1)) = 0.16
